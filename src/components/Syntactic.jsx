        ...
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              La segunda fase del compilador es el análisis sintáctico o
              parsing. El parser (analizador sintáctico) utiliza los primeros
              componentes de los tokens producidos por el analizador de léxico
              para crear una representación intermedia en forma de árbol que
              describa la estructura gramatical del flujo de tokens.
            </p>
          ...
          <div className="relative mt-16 h-80 lg:mt-8">
            <img
              className="absolute left-0 top-0 w-[40rem] h-85 max-w-none rounded-xl bg-white/5 ring-1 ring-white/10"
              src="../../public/compiler2.jpg"
              alt="App screenshot"
              width={1824}
              height={1080}
            />
          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              <p className="mt-6 text-xl leading-8 text-gray-700 text-justify">
                Una representación típica es el árbol sintáctico, en el cual
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <p>
                En la figura de la derecha se muestra un árbol sintáctico para
                el flujo de tokens como salida del analizador sintáctico.
              </p>
